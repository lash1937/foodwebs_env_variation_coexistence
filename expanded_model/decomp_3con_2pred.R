...
invade_C1 <- function(mat, M_C1_temp, M_C2_temp, M_C3_temp) {
  ...
  for (t in invade_start_time:time) {
    ...
    C1_ldgr[counter] <- log (VF_out[2, 4] / .001)
    C2_resident[counter] <- log (VF_out[2, 5] / VF_out[1, 5])
    C3_resident[counter] <- log (VF_out[2, 6] / VF_out[1, 6])
    counter <- counter + 1
  }
...
invade_C2 <- function(mat, M_C1_temp, M_C2_temp, M_C3_temp) {
  ...
  for (t in invade_start_time:time) {
    ...
    C2_ldgr[counter] <- log (VF_out[2, 5] / .001)
    C1_resident[counter] <- log (VF_out[2, 4] / VF_out[1, 4])
    C3_resident[counter] <- log (VF_out[2, 6] / VF_out[1, 6])
    counter <- counter + 1
  }
...
invade_C3 <- function(mat, M_C1_temp, M_C2_temp, M_C3_temp) {
  ...
  for (t in invade_start_time:time) {
    ...
    C3_ldgr[counter] <- log (VF_out[2, 6] / .001)
    C1_resident[counter] <- log (VF_out[2, 4] / VF_out[1, 4])
    C2_resident[counter] <- log (VF_out[2, 5] / VF_out[1, 5])
    counter <- counter + 1
  }
...
runall <- function(sigma, rho, time) {
  ...
  avg_predator2_C1_invade_C2_resident_C3_resident <-
    mean(C1_invade_C2_resident_C3_resident[invade_start_time:time, 2])
  
  avg_predator2_C2_invade_C1_resident_C3_resident <-
    mean(C2_invade_C1_resident_C3_resident[invade_start_time:time, 2])
  
  avg_predator2_C3_invade_C1_resident_C2_resident <-
    mean(C3_invade_C1_resident_C2_resident[invade_start_time:time, 2])
